(function () {
    ...
    function boot () {
        ...
        function setLoadingDisplay () {
            ...
            //window.showTextureOK
            cc.director.once(cc.Director.EVENT_AFTER_SCENE_LAUNCH, function () {
                window.bEngineLoaded = true;
                var target = {
                    update: function () {
                        if(window.showTextureOK) {
                ...
                var scheduler = cc.director.getScheduler();
                scheduler.scheduleUpdateForTarget(target, 0, false);
            });
        }
        ...
        var bundledScript = settings.debug ? 'project.dev.js' : 'project.js?version=' + Date.now();
        if (jsList) {
